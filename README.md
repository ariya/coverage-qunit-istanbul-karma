This repo contains an example setup for tracking code coverage of [QUnit](http://qunitjs.com) tests via [Istanbul](http://gotwarlost.github.io/istanbul/) and [Karma](http://karma-runner.github.io/).
